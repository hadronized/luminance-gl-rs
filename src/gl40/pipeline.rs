...
pub type Pipeline<'a, L, D, CS, DS> = pipeline::Pipeline<'a, GL40, L, D, CS, DS>;
pub type ShadingCommand<'a, T> = pipeline::ShadingCommand<'a, GL40, T>;
pub type RenderCommand<'a, T> = pipeline::RenderCommand<'a, GL40, T>;

impl HasPipeline for GL40 {
