use gl;
use gl::types::*;
use gl40::texture::{GLTexture, create_texture, to_target};
use gl40::token::GL40;
...
pub type Framebuffer<L, D, CS, DS> = framebuffer::Framebuffer<GL40, L, D, CS, DS>;
pub type Slot<L, D, P> = framebuffer::Slot<GL40, L, D, P>;
